...
# indir="/nfs/scistore12/hpcgrp/jyeung/projects/motif_inference/workflows"
indir="/nfs/scistore12/hpcgrp/jyeung/projects/motif_inference/workflows/2-motevo_and_downstream"
cd $indir
