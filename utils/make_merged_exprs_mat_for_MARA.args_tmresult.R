...
parser$add_argument('infile', metavar='INFILE',
                                            help='rds file of list "topics" and "terms". Topics (cells by topic) is n by k, terms (topic to region) is k by m')
...
parser$add_argument('--AddTopicStr', action="store_true", default=FALSE,
                                            help='Add topic_ string to colname of topics and rownames of terms. Should do if purely from topicmodels output')
