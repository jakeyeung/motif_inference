...
N="/nfs/scistore12/hpcgrp/jyeung/IST_data/Siegert_lab/motevo_outputs_fa_fix_full/motevo_outputs/bed/intersect_with_TSS/summed_across_genes/merged/selected_motifs_intersect_with_TSS.txt"
[[ ! -e $N ]] && echo "$N not found, exiting" && exit 1

outmain="/nfs/scistore12/hpcgrp/jyeung/IST_data/Siegert_lab/mara_outputs_RNAseq_selected_motifs"
